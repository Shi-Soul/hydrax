...
def _render_template(
    ...
    ).replace(task_dashboard_marker, task_dashboard_href)
...
def _run(cfg: DictConfig) -> None:
    ...
    (output_dir / "index.html").write_text(
        _render_template(template, summary, "", "../../task_dashboard.html"),
        encoding="utf-8",
    )
